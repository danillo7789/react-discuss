        ...
        <div className='sticky-top'>
            <nav className="navbar navbar-expand-lg bg-nav py-3">
                <div className="container">
                    <Link onClick={homeRefresh} className="linkc brand-name" to='/'><h4>Diskors</h4></Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent" style={{ color: 'white' }}>
                        ...
                        {isLoggedIn? (<ul className="navbar-nav nav-text mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown nav-text">
                                <a className="linkc dim" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    @{user?.username} <img width="30" height="30" src="https://img.icons8.com/ios-glyphs/30/7F91EB/expand-arrow--v1.png" alt="expand-arrow--v1"/>
                                </a>
